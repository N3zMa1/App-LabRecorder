...
public:
	 ...
	 */
	recording(const std::string &filename, const std::string& participant, const std::string& session, const std::string& task, const std::string& run, const std::map<std::string, std::string> &addtionalInfo,const std::vector<lsl::stream_info> &streams,
